...
export class AssistantView extends LitElement {
    static styles = css`
        ...
        * {
        ...
        .question-text {
            ...
            max-height: 100px; /* Limit height but allow scrolling */
            overflow-y: auto; /* Add scrollbar if needed */
            padding-right: 10px; /* Space for scrollbar */
        }

        .response-container {
            height: calc(100% - 140px); /* Adjusted for question bar and input area */
            overflow-y: auto;
            border-radius: 10px;
    ...
    static properties = {
        ...
        vadMode: { type: String },
        currentQuestion: { type: String }, // New property for current question
    ...
    constructor() {
        ...
        // Current question starts as empty
    ...
    updated(changedProperties) {
        ...
        if (changedProperties.has('responses') || changedProperties.has('currentResponseIndex') || changedProperties.has('currentQuestion')) {
    ...
    updateResponseContent() {
        ...
        if (container) {
            ...
            // Removed automatic scroll to bottom - user can manually scroll if needed
            // this.scrollToBottom();
        } else {
    ...
    render() {
        ...
        return html`
            <div class="question-bar">
                <span class="question-label">QS:</span>
                <span class="question-text">${this.currentQuestion || ''}</span>
            </div>
